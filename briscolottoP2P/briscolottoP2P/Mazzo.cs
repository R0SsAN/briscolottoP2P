...
namespace briscolottoP2P
{
    public class Mazzo
    {
        ...
        public void caricaMazzo()
        {
            ...
            mazzo.Add(c);
            c = new Carta("b", 11, 10, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/bastoni/3b.gif");
            mazzo.Add(c);
            c = new Carta("b", 2, 0, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/bastoni/2b.gif");
            mazzo.Add(c);
            c = new Carta("b", 12, 11, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/bastoni/1b.gif");
            mazzo.Add(c);
            #endregion
            ...
            mazzo.Add(c);
            c = new Carta("c", 11, 10, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/coppe/3c.gif");
            mazzo.Add(c);
            c = new Carta("c", 2, 0, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/coppe/2c.gif");
            mazzo.Add(c);
            c = new Carta("c", 12, 11, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/coppe/1c.gif");
            mazzo.Add(c);
            #endregion
            ...
            mazzo.Add(c);
            c = new Carta("d", 11, 10, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/denari/3d.gif");
            mazzo.Add(c);
            c = new Carta("d", 2, 0, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/denari/2d.gif");
            mazzo.Add(c);
            c = new Carta("d", 12, 11, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/denari/1d.gif");
            mazzo.Add(c);
            #endregion
            ...
            mazzo.Add(c);
            c = new Carta("s", 11, 10, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/spade/3s.gif");
            mazzo.Add(c);
            c = new Carta("s", 2, 0, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/spade/2s.gif");
            mazzo.Add(c);
            c = new Carta("s", 12, 11, "https://raw.githubusercontent.com/R0SsAN/briscolottoP2P/main/img_carte/spade/1s.gif");
            mazzo.Add(c);
            #endregion
        }
        ...
        public Carta completaCarta(Carta temp)
        {
            ...
            {
                if (temp.seme == mazzo[i].seme && temp.valore == mazzo[i].valore)
                    return mazzo[i];
            }
            return null;
        }
